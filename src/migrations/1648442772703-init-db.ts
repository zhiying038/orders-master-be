...
export class initDb1648442772703 implements MigrationInterface {
  name = 'initDb1648442772703';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ORDERS" ("Id" uniqueidentifier NOT NULL CONSTRAINT "DF_bdc0b9d5929e07dff242f7bcce7" DEFAULT NEWSEQUENTIALID(), "ReferenceNumber" nvarchar(255) NOT NULL, "TotalPrice" float NOT NULL, "currency" nvarchar(255) NOT NULL CONSTRAINT "DF_43fc8b77ba4eabce5541a0728d6" DEFAULT 'MYR', "CreatedAt" datetimeoffset NOT NULL CONSTRAINT "DF_a8a2209a84525a726dd136bc4fb" DEFAULT getdate(), CONSTRAINT "PK_bdc0b9d5929e07dff242f7bcce7" PRIMARY KEY ("Id"))`,
    );
    await queryRunner.query(
